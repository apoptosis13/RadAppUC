    ...
    return (
        <div className="text-center py-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">
                {t('aiQuiz.results.title', '¡Desafío Completado!')}
            </h2>

            <p className="text-gray-500 dark:text-gray-400 mb-8">
                {t('aiQuiz.results.subtitle', 'Has completado el diagnóstico diferencial.')}
            </p>
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-2xl p-8 max-w-sm mx-auto shadow-2xl mb-8 transform hover:scale-105 transition-transform duration-300">
                <div className="text-sm font-medium opacity-90 uppercase tracking-wider mb-1">{t('aiQuiz.results.finalScore', 'Puntaje Final')}</div>
                ...
                <div className="text-xs opacity-80">{t('aiQuiz.results.praise', '¡Gran trabajo, Doctor!')}</div>
            </div>
            ...
            <div className="flex justify-center space-x-4">
                ...
                >
                    ...
                    {t('aiQuiz.results.retry', 'Intentar de Nuevo')}
                </button>
            </div>
        </div>
    );
