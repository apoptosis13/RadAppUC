        ...
        <div className="text-center space-y-6">
            ...
            <div>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                    Desafío de Diagnóstico Diferencial
                </h2>
                <p className="text-lg text-indigo-600 dark:text-indigo-400 font-medium">
                    {diagnosis}
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
                    Nivel: {difficulty === 'Beginner' ? 'R1 (Principiante)' : difficulty === 'Intermediate' ? 'R2 (Intermedio)' : 'R3 (Avanzado)'}
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto text-left">
                <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                        ...
                        <h3 className="font-semibold text-gray-900 dark:text-white">10 Preguntas</h3>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                        Generadas con IA específicamente para este caso.
                    </p>
                </div>
                <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                        <Clock className="w-5 h-5 text-green-500" />
                        <h3 className="font-semibold text-gray-900 dark:text-white">Tiempo Limitado</h3>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                        Suma puntos extra por responder rápido.
                    </p>
                </div>
                <div className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div className="flex items-center space-x-2 mb-2">
                        <Trophy className="w-5 h-5 text-yellow-500" />
                        <h3 className="font-semibold text-gray-900 dark:text-white">2 Oportunidades</h3>
                    </div>
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                        Si fallas, tienes un segundo intento por mitad de puntaje.
                    </p>
                </div>
            </div>
